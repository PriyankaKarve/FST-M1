	...
	public class googleTask_Activity1 {
	    ...
	    public void beforeClass() throws MalformedURLException {
		  ...
		  public void addTask() {
			  ...
			  String[] tasksToAdd = {
					  "Task 1 - Complete Activity with Google Tasks",
					  "Task 2 - Complete Activity with Google Keep",
					  "Task 3 - Complete the second Activity Google Keep"
			  };
			  ...
			  for (String taskToAdd : tasksToAdd) {
				...
				assertEquals(tasksAdded.get(3).getText(), "Task 3 - Complete the second Activity Google Keep");
		  }
